...
- Dê uma olhada nos [Materiais úteis](https://github.com/PicPay/picpay-desafio-backend#materiais-%C3%BAteis);
- Dê uma olhada em como será a [entrevista](https://github.com/PicPay/picpay-desafio-backend#para-o-dia-da-entrevista-t%C3%A9cnica);
...
- Antes de finalizar a transferência, deve-se consultar um serviço autorizador externo, use este mockhttps://util.devi.tools/api/v2/authorizepara simular o serviço utilizando o verbo `GET`;
...
Caso use PHP tente seguir as [PSRs](https://www.php-fig.org/psr/psr-12/), caso use outro framework ou linguagem, tente seguir as boas práticas da comunidade.
